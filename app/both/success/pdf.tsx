...
const PDF = () => {
    ...
    Object.keys(pages).forEach((id) => {
        ...
        y = getY(y,5)
        doc.text(`Contribution: ${pageData.contributorType} and ${pageData.masterContributorType}`, x, y);
        y = getY(y,5)
    ...
    y = getY(y,5)
    doc.text(`Contribution: ${pageData.contributorType} and ${pageData.masterContributorType}`, x/2, y);
    y = getY(y,5)
